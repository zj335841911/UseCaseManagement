...
CREATE TABLE `ibzauthlog` (
  ...
  `AUTHTIME` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `ibzcfg` (
  ...
  `UPDATEDATE` datetime DEFAULT '1970-00-00 00:00:00',
  PRIMARY KEY (`CFGID`)
...
CREATE TABLE `ibzdataaudit` (
  ...
  `OPTIME` date DEFAULT '1970-00-00',
...
CREATE TABLE `ibzdept` (
  ...
  `CREATEDATE` datetime DEFAULT '1970-00-00 00:00:00',
  `UPDATEDATE` datetime DEFAULT '1970-00-00 00:00:00',
  PRIMARY KEY (`DEPTID`),
...
CREATE TABLE `ibzemp` (
  ...
  `BIRTHDAY` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `ibzfile` (
  ...
  `CREATEDATE` date DEFAULT '1970-00-00',
  `UPDATEMAN` varchar(60) DEFAULT NULL,
  `UPDATEDATE` date DEFAULT '1970-00-00',
...
CREATE TABLE `zt_action` (
  ...
  `date` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_bug` (
  ...
  `activatedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `mailto` text DEFAULT NULL,
  `openedBy` varchar(30) NOT NULL DEFAULT '',
  `openedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `openedBuild` varchar(255) NOT NULL,
  `assignedTo` varchar(30) NOT NULL DEFAULT '',
  `assignedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `deadline` date DEFAULT '1970-00-00',
  `resolvedBy` varchar(30) NOT NULL DEFAULT '',
  `resolution` varchar(30) NOT NULL DEFAULT '',
  `resolvedBuild` varchar(30) NOT NULL DEFAULT '',
  `resolvedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `closedBy` varchar(30) NOT NULL DEFAULT '',
  `closedDate` datetime DEFAULT '1970-00-00 00:00:00',
  ...
  `lastEditedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `deleted` enum('0','1') NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `product` (`product`),
  KEY `project` (`project`),
...
CREATE TABLE `zt_case` (
  ...
  `scriptedDate` date DEFAULT '1970-00-00',
  ...
  `reviewedDate` date DEFAULT '1970-00-00',
  ...
  `lastRunDate` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_compile` (
  ...
  `createdDate` datetime DEFAULT '1970-00-00 00:00:00',
  `updateDate` datetime DEFAULT '1970-00-00 00:00:00',
  `deleted` enum('0','1') NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `zt_cron` (
  ...
  `lastTime` datetime DEFAULT '1970-00-00 00:00:00',
  PRIMARY KEY (`id`),
...
CREATE TABLE `zt_doc` (
  ...
  `addedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `editedBy` varchar(30) NOT NULL,
  `editedDate` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_effort` (
  ...
  `date` date DEFAULT '1970-00-00',
  `begin` datetime DEFAULT '1970-00-00 00:00:00',
  `end` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_extension` (
  ...
  `installedTime` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_im_chat` (
  ...
  `editedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `lastActiveTime` datetime DEFAULT '1970-00-00 00:00:00',
  `dismissDate` datetime DEFAULT '1970-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `gid` (`gid`),
  KEY `name` (`name`),
  KEY `type` (`type`),
...
CREATE TABLE `zt_im_chatuser` (
  ...
  `join` datetime DEFAULT '1970-00-00 00:00:00',
  `quit` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_im_queue` (
  ...
  `content` text NOT NULL,
  `addDate` datetime DEFAULT '1970-00-00 00:00:00',
  `processDate` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_job` (
  ...
  `editedBy` varchar(30) NOT NULL,
  `editedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `lastExec` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_notify` (
  ...
  `createdDate` datetime DEFAULT '1970-00-00 00:00:00',
  `sendTime` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_productplan` (
  ...
  `desc` text NOT NULL,
  `begin` date DEFAULT '1970-00-00',
  `end` date DEFAULT '1970-00-00',
  `order` text NOT NULL,
  `deleted` enum('0','1') NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `product` (`product`),
...
CREATE TABLE `zt_repo` (
  ...
  `lastSync` datetime DEFAULT '1970-00-00 00:00:00',
  `desc` text NOT NULL,
...
CREATE TABLE `zt_repohistory` (
  ...
  `time` datetime DEFAULT '1970-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `repo` (`repo`),
  KEY `revision` (`revision`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `zt_task` (
  ...
  `assignedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `estStarted` date DEFAULT '1970-00-00',
  `realStarted` date DEFAULT '1970-00-00',
  `finishedBy` varchar(30) NOT NULL,
  `finishedDate` datetime DEFAULT '1970-00-00 00:00:00',
  `finishedList` text NOT NULL,
  `canceledBy` varchar(30) NOT NULL,
  `canceledDate` datetime DEFAULT '1970-00-00 00:00:00',
...
CREATE TABLE `zt_user` (
  ...
  `birthday` date DEFAULT '1970-00-00',
  ...
  `locked` datetime DEFAULT '1970-00-00 00:00:00',
